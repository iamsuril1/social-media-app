...
$following_list = mysqli_fetch_all(mysqli_stmt_get_result($stmt), MYSQLI_ASSOC);
...
<div class="friends-card">
    <h2><?php echo htmlspecialchars($profile_name); ?> is Following <span class="count-badge"><?php echo count($following_list); ?></span></h2>

    <?php if (empty($following_list)): ?>
        <p class="empty-text">Not following anyone yet.</p>
    <?php else: ?>
        <div class="user-list">
            <?php foreach ($following_list as $person): ?>
                <div class="user-row">
                    <div class="user-info">
